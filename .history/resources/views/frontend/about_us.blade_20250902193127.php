...
<div class="why-choose-us-section py-5">
    <div class="container">
        <div class="section-title mb-5">
            <h2><i class="fas fa-question-circle me-2"></i>Why Choose Us?</h2>
            <p class="lead" style="color:#622c2c;">Discover the difference with Parekh Jewellers – where tradition meets innovation.</p>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-4 mb-4">
                <div class="choose-card animated-card">
                    <div class="choose-icon"><i class="fas fa-gem"></i></div>
                    <h4 class="choose-title">Certified Purity</h4>
                    <p>Every piece is hallmarked and certified for purity, ensuring you get only the finest quality gold, silver, and platinum.</p>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="choose-card animated-card">
                    ...
                    <p>Our master craftsmen blend tradition with modern trends to create exclusive, eye-catching jewellery for every occasion.</p>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="choose-card animated-card">
                    ...
                    <p>Serving generations with honesty and excellence, Parekh Jewellers is a name you can trust for your precious moments.</p>
                </div>
            </div>
        </div>
    </div>
...
<style>
.why-choose-us-section {
    background: linear-gradient(135deg, #fff7e6 0%, #f7f1f1 100%);
    border-radius: 30px;
    box-shadow: 0 10px 40px rgba(98,44,44,0.08);
    margin-bottom: 60px;
}
.choose-card {
    background: #fff;
    border-radius: 20px;
    box-shadow: 0 8px 30px rgba(98,44,44,0.12);
    padding: 40px 25px;
    text-align: center;
...
.choose-card:hover {
    ...
    box-shadow: 0 16px 50px #FAC45655;
}
.choose-icon {
    font-size: 2.8rem;
    color: #FAC456;
...
<script>
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.animated-card').forEach(function(card, i) {
        setTimeout(function() {
            card.style.opacity = '1';
            card.style.transform = 'translateY(0)';
            card.style.animation = 'fadeUp 0.7s cubic-bezier(.23,1,.32,1) forwards';
        }, 300 + i * 250);
    });
});
</script>
