...
body {
    ...
    background: linear-gradient(135deg, #0a0a23, #1a1a3a); /* Deep navy gradient */
    color: #fff;
    overflow-x: hidden;
}
...
.geo-circle { width: 100px; height: 100px; top: 10%; left: 20%; }
.geo-triangle { width: 80px; height: 80px; clip-path: polygon(50% 0%, 0% 100%, 100% 100%); top: 30%; left: 70%; }
.geo-hexagon { width: 90px; height: 90px; clip-path: polygon(25% 0%, 75% 0%, 100% 50%, 75% 100%, 25% 100%, 0% 50%); top: 60%; left: 40%; }
.geo-diamond { width: 70px; height: 70px; clip-path: polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%); top: 80%; left: 10%; }
...
.sparkle-layer {
    ...
    width: 100%;
    height: 100%;
    background: url('https://i.imgur.com/sparkle.png') repeat; /* Use a sparkle sprite or image */
...
@keyframes glow {
    0%, 100% { text-shadow: 0 0 10px rgba(250, 192, 79, 0.7); }
    50% { text-shadow: 0 0 20px rgba(250, 192, 79, 1); }
}
...
@media (max-width: 768px) {
    ...
    .layout-btn { padding: 10px 15px; font-size: 0.9rem; }
    .hex-card { width: 150px; height: 170px; }
}
</style>
