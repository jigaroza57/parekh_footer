    ...
    <div class="row p-4">
        <div class="col-md-3 ">
            <center>
                ...
                <br>
                <br>
                <p style="color: white; text-align: justify;">Welcome to the exquisite world of Parekh Pravinchandra Hiralal & Co., where timeless elegance meets unparalleled craftsmanship. </p>
