...
<footer style=" background-color: #581E1E; 
               background-image: url('{{ asset('/images/new/Footer Repeat Grid.svg') }}'); 
    ...
    <div class="row p-4">
        ...
        <div class="col-lg-3">
            ...
            <br>
                   ...
                   <img src="{{ asset('images/new/Parekh Jewellers Website Map.png')}}" class="img-fluid" alt="">
