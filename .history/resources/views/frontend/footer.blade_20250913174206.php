        ...
        <div class="col-md-3 ">
            <center>
                ...
                <div class="text-center mt-1">
                    <a href="{{ $detail->fb_link }}" class="mx-2" style="padding-right:5px;color:#3B0000;"><i class="fab fa-facebook-f" style="font-size: 26px;"></i></a>
                    <a href="{{ $detail->insta_link }} " class="mx-2" style="padding-right:5px;color:#3B0000;"><i class="fab fa-instagram" style="font-size: 26px;"></i></a>
                    <a href="{{ $detail->whatsapp_link }}" class="mx-2" style="padding-right:5px;color:#3B0000;"><i class="fab fa-whatsapp" style="font-size: 26px;"></i></a>
