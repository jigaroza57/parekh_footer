        ...
        <div class="col-lg-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <ul class="menu-list">
                        <li><a class="fw-semibold " style="color: ;" href="{{ route('frontend.about_us') }}">Our Story</a></li>
                        <br>
                        <li><a class="fw-semibold " style="color: ;" href="{{ route('frontend.product') }}">Collections</a></li>
                        <br>

                        <li><a class="fw-semibold " style="color: ;" href="{{ route('frontend.update') }}">Latest News</a></li>
                        <br>

                        <li><a class="fw-semibold " style="color: ;" href="{{ route('frontend.blog') }}">Journal</a></li>
                        <br>

                        <li><a class="fw-semibold " style="color: ;" href="{{ route('frontend.getTouch') }}">Social Sparkle</a></li>
                        <br>

                        <li><a class="fw-semibold " style="color: ;" href="{{ route('frontend.contact_us') }}">Get In Touch</a></li>
                    </ul>
