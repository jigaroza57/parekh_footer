    ...
    <div class="row p-4">
        ...
        <div class="col-lg-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <!-- <center> -->
                    <h2 style="color: #3B0000; font-family: 'Aladin', system-ui; letter-spacing: 3px; font-weight: bold;">Useful Links</h2>
                    <!-- </center> -->
                    <br>

                    <ul class="menu-list">
                        <li><a class="fw-semibold " style="color: #3B0000; font-weight: 900;" href="{{ route('frontend.about_us') }}">Our Story</a></li>
                        <br>
                        <li><a class="fw-semibold " style="color: #3B0000; font-weight: 900;" href="{{ route('frontend.product') }}">Collections</a></li>
                        <br>

                        <li><a class="fw-semibold " style="color: #3B0000; font-weight: 900;" href="{{ route('frontend.update') }}">Latest News</a></li>
                        <br>

                        <li><a class="fw-semibold " style="color: #3B0000; font-weight: 900;" href="{{ route('frontend.blog') }}">Journal</a></li>
                        <br>

                        <li><a class="fw-semibold " style="color: #3B0000; font-weight: 900;" href="{{ route('frontend.getTouch') }}">Social Sparkle</a></li>
                        <br>

                        <li><a class="fw-semibold " style="color: #3B0000; font-weight: 900;" href="{{ route('frontend.contact_us') }}">Get In Touch</a></li>
                    </ul>
