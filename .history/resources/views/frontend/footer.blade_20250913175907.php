...
<footer style=" background-image: url('{{ asset('/images/new/Parekh Footer img.png') }}');  
    ...
    <center>
        <p style="margin-bottom: -10px;  color: ;">Copyright © {{ \Carbon\Carbon::now()->year }} Parekh Pravinchandra Hiralal & Co.
            Designed by <a style="color:;" href="https://www.apexsoftwarehouse.com">Apex Software House</a></p>
    </center>
