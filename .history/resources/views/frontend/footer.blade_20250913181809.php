    ...
    <div class="row p-4">
        ...
        <div class="col-lg-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 clickable-div" onclick="window.location.href='https://maps.app.goo.gl/FQRDg4Njn6XDi6Km8';" style="background-color:trans; height:200px; cursor:pointer;">
                </div>
