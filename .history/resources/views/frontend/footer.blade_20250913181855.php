...
<footer style=" background-image: url('{{ asset('/images/new/Parekh Footer img.png') }}');  
  ...
  background-position: 35% center;  
    ...
    <div class="row p-4">
        ...
        <div class="col-md-6 clickable-div" onclick="window.location.href='https://maps.app.goo.gl/FQRDg4Njn6XDi6Km8';" style="background-color:black; height:200px; cursor:pointer;"></div>
        ...
        <div class="col-lg-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 clickable-div" onclick="window.location.href='https://maps.app.goo.gl/FQRDg4Njn6XDi6Km8';" style="background-color:black; height:200px; cursor:pointer;">
                </div>
