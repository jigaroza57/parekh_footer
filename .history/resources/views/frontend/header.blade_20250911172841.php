...
<style>
    ...
    .logo-bg {
        ...
        /* keeps contrast */
        padding: 8px 20px;
        /* reduced padding for proper sizing */
        border-radius: 8px;
        /* smooth corners instead of clip-path */
        display: flex;
        align-items: center;
    ...
    .logo-img {
        ...
        filter: drop-shadow(0 2px 6px rgba(255, 194, 88, 0.7));
        /* gold highlight */
    }

    .logo-img:hover {
        transform: scale(1.08);
        filter: drop-shadow(0 3px 8px rgba(255, 194, 88, 1));
    }
