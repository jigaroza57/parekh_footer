...
<nav class="navbar navbar-expand-lg navbar-dark sticky-top shadow-sm main-navbar">
    ...
    <!-- Desktop Header -->
    <div class="container-fluid px-lg-5 py-2 d-none d-lg-flex align-items-center justify-content-between">
    ...
    <!-- Mobile Header -->
    <div class="container-fluid py-2 d-flex d-lg-none align-items-center justify-content-between">
...
<style>
    ...
    @media (max-width: 768px) {
        .logo-bg {
            ...
            /* smaller padding */
            clip-path: none;
            /* optional - makes it rectangular on mobile */
        ...
        /* Search popup takes full width in mobile */
        #searchPopup {
            width: 100% !important;
            right: auto;
            left: 0;
