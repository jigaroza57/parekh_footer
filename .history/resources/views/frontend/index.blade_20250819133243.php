    ...
    <div class="categories-container">
        ...
        <div class="categories-grid">
            ...
            <div class="category-card" data-category="jewelry">
                ...
                <h3 class="category-name">Fine Jewelry</h3>
                <p class="category-desc">Elegant & Timeless Pieces</p>
            ...
            <div class="category-card featured" data-category="electronics">
                ...
                <p class="category-desc">Smart & Innovative Tech</p>
                <div class="category-stats">
                    <div class="stat-item">
                        <i class="fas fa-box"></i>
                        <span>250+ Items</span>
            ...
            <div class="category-card" data-category="fashion">
                ...
                <p class="category-desc">Trendy & Premium Style</p>
                <div class="category-stats">
                    <div class="stat-item">
                        <i class="fas fa-box"></i>
                        <span>180+ Items</span>
            ...
            <div class="category-card" data-category="home">
                ...
                <p class="category-desc">Luxury Comfort & Style</p>
                <div class="category-stats">
                    <div class="stat-item">
                        <i class="fas fa-box"></i>
                        <span>95+ Items</span>
            ...
            <div class="category-card" data-category="books">
                ...
                <p class="category-desc">Knowledge & Adventure</p>
                <div class="category-stats">
                    <div class="stat-item">
                        <i class="fas fa-box"></i>
                        <span>300+ Items</span>
            ...
            <div class="category-card" data-category="sports">
                ...
                <p class="category-desc">Performance & Excellence</p>
                <div class="category-stats">
                    <div class="stat-item">
                        <i class="fas fa-box"></i>
                        <span>75+ Items</span>
