...
<style>
    ...
    .about-section {
        ...
        /* Soft beige for a warm, premium feel */
        border-radius: 0;
        /* Remove rounding for a full-width modern look */
        padding: 100px 0;
        /* More padding for breathing space */
        position: relative;
        overflow: hidden;
    }
    ...
    .section-title {
        font-family: 'Playfair Display', serif;
        font-size: 4rem;
        /* Larger for impact in modern designs */
        font-weight: 700;
    ...
    .section-text {
        ...
        /* Modern sans-serif for elegance */
        font-size: 1.15rem;
        line-height: 1.9;
        color: #4a4a4a;
