...
<div class="category-section-glass">
    <div class="hero-content-glass">
        ...
        <h1 class="glass-title">
            <span class="strong-text">Discover Our</span>
            <span class="gold-text">Curated Categories</span>
        </h1>
    ...
    <div class="categories-glass-grid">
        ...
        <a href="{{ route('frontend.product_by_category',['id' => $cat->id]) }}" class="category-glass-link">
            <div class="category-glass-card" tabindex="0" style="--i:{{$loop->index}};" data-category="{{ strtolower($cat->name) }}">
                ...
                <div class="glass-card-image">
                    <img src="{{ asset('images/category/'.$cat->image) }}" alt="{{ $cat->name }}"
                         onerror="this.style.display='none';this.parentNode.classList.add('glass-card-image-fallback');">
                </div>
                <h3 class="glass-card-name">{{ $cat->name }}</h3>
                <div class="glass-hover-cta">
