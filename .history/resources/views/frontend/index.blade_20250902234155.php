...
<div style="display: flex; ">
    <!-- First Banner -->
    <div style="position: relative; overflow: hidden; width: 100%;  cursor: pointer;">
        <img src="{{ asset('images/new/h1_bn-1.jpg')}}" style="width: 100%; transition: transform 0.6s ease;" alt="">
        <div style="position: absolute; top: 20%; left: 10%; color: #000; max-width: 60%;">
            <p style="font-size: 12px; letter-spacing: 1px; text-transform: uppercase; margin: 0;transition: transform 0.6s ease;">Our Earrings</p>
            <h2 style="font-size: 28px; font-weight: bold; margin: 5px 0;transition: transform 0.6s ease;">Add These <br> To Your Style <br> Roster.</h2>
            <p style="font-size: 14px; margin-bottom: 15px;transition: transform 0.6s ease;">Grab the deal right now! You can get <br> extra 15% off this season.</p>
            <br>
            <a href="#" style="background: #fff; padding: 10px 20px; border-radius: 6px; text-decoration: none; color: #000; font-weight: 600;transition: transform 0.6s ease;">Shop Now</a>
        </div>
    </div>

    <!-- Second Banner -->
    <div style="position: relative; overflow: hidden; width: 100%;  cursor: pointer;">
        <img src="{{ asset('images/new/h1_bn-2.jpg')}}" style="width: 100%; transition: transform 0.6s ease;" alt="">
        <div style="position: absolute; top: 20%; left: 10%; color: #000; max-width: 60%;">
            <p style="font-size: 12px; letter-spacing: 1px; text-transform: uppercase; margin: 0;">Favorite Items</p>
            <h2 style="font-size: 28px; font-weight: bold; margin: 5px 0;">Unique <br> Engagement <br> Rings</h2>
            <p style="font-size: 14px; margin-bottom: 15px;">From special antique diamonds to <br> one-of-a-kind colored gemstones.</p>
            <br>
            <a href="#" style="background: #fff; padding: 10px 20px; border-radius: 6px; text-decoration: none; color: #000; font-weight: 600;">Shop Now</a>
        </div>
    </div>
</div>
