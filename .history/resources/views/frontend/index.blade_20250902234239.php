...
<div style="display: flex; ">
    ...
    <div style="position: relative; overflow: hidden; width: 100%;  cursor: pointer;">
        ...
        <div style="position: absolute; top: 20%; left: 10%; color: #000; max-width: 60%;">
            <p style="font-size: 12px; letter-spacing: 1px; text-transform: uppercase; margin: 0;">Our Earrings</p>
            <h2 style="font-size: 28px; font-weight: bold; margin: 5px 0;">Add These <br> To Your Style <br> Roster.</h2>
...
<!-- Hover Effect -->
<style>
    div[style*="overflow: hidden;"]:hover img , p, h2 {
        transform: scale(1.1);
    }
</style>
