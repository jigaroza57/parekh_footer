...
<div style="display: flex;">
    <!-- First Banner -->
    <div class="banner">
        <img src="{{ asset('images/new/h1_bn-1.jpg')}}" alt="">
    ...
    <!-- Second Banner -->
    <div class="banner">
        <img src="{{ asset('images/new/h1_bn-2.jpg')}}" alt="">
        <div class="banner-text">
            <p>Favorite Items</p>
...
<div class="scroll-container">
  <div class="scroll-content">
    ...
    <span>💎 Shine With Elegance</span>
    <span>🌟 Timeless Luxury</span>
    <span>💍 Perfect Engagement Picks</span>
    <span>🛍️ Black Friday Exclusive</span>
    <span>🎁 Gifts That Sparkle</span>
    <span>🌸 Elegant And Everlasting</span>
    <span>💖 Color In Your Look</span>
  </div>
...
<style>
  ...
  .scroll-container {
    ...
    overflow: hidden;
    white-space: nowrap;
    background: linear-gradient(90deg, #581E1E, #F8BA4B);
    padding: 14px 0;
  }
  ...
  /* Divider line between each text */
  ...
  /* Remove divider from last child (for neatness) */
