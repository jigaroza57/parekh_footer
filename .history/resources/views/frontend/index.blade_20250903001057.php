...
<style>
    ...
    .hero-section2 {
        ...
        font-family: 'Inter Tight', sans-serif;
        background: url("{{ asset('images/new/h1_bg-2.jpg')}}") no-repeat center center;
        background-size: cover;
        transition: background-size 0.7s ease; /* smooth zoom effect */
    }

    /* only background zoom on hover */
    .hero-section2:hover {
        background-size: 110%;
    }
