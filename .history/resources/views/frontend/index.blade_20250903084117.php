...
<div style="display: flex;">
    <!-- First Banner -->
    <div class="banner" style="background-image: url('{{ asset('images/new/h1_bn-1.jpg') }}');">
    ...
    <!-- Second Banner -->
    <div class="banner" style="background-image: url('{{ asset('images/new/h1_bn-2.jpg') }}');">
        <div class="banner-text">
            <p>Favorite Items</p>
...
<style>
    .banner {
        ...
        overflow: hidden;
        width: 100%;
        height: 400px; /* 👈 tamne jetli height joiye hoy etli set karo */
        cursor: pointer;
    ...
    .banner:hover {
        background-size: 110%; /* hover effect */
    }
