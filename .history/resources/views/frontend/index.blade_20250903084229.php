...
<div style="display: flex;">
    <!-- First Banner -->
    <div class="banner" style="background-image: url('{{ asset('images/new/h1_bn-1.jpg') }}'); height: 100%; width: 100%;">
    ...
    <!-- Second Banner -->
    <div class="banner" style="background-image: url('{{ asset('images/new/h1_bn-2.jpg') }}'); height: 100%; width: 100%;">
        <div class="banner-text">
            <p>Favorite Items</p>
...
<style>
    .banner {
        ...
        width: 100%;
        height: 400px;
        /* 👈 tamne jetli height joiye hoy etli set karo */
        cursor: pointer;
