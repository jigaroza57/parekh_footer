...
<div class="gallery">
    ...
    <img src="/images/product/01 736x736 (1).jpg" onclick="openLightbox(1)">
    <img src="/images/product/01 736x736 (1).jpg" onclick="openLightbox(2)">
    <img src="/images/product/01 736x736 (1).jpg" onclick="openLightbox(3)">
    <img src="/images/product/01 736x736 (1).jpg" onclick="openLightbox(4)">
    <img src="/images/product/01 736x736 (1).jpg" onclick="openLightbox(5)">
    <img src="/images/product/01 736x736 (1).jpg" onclick="openLightbox(6)">
    <img src="/images/product/01 736x736 (1).jpg" onclick="openLightbox(7)">
</div>
...
<script>
    ...
    function openLightbox(index) {
        ...
        // start auto slide every 3 sec
        autoSlide = setInterval(() => changeSlide(1), 3000);
    }

    function closeLightbox() {
        document.getElementById('lightbox').classList.remove('active');
        clearInterval(autoSlide); // stop auto slide when closed
    }
