...
<div class="slider-container">
    <div class="slider" id="slider">
        <img src="/images/product/01 736x736 (1).jpg">
        <img src="/images/product/01 736x736 (1).jpg">
        <img src="/images/product/01 736x736 (1).jpg">
        <img src="/images/product/01 736x736 (1).jpg">
        <img src="/images/product/01 736x736 (1).jpg">
...
<script>
    ...
    const visibleSlides = 6; // ek vaar ma 6 image
    let index = 0;

    function moveSlider() {
        index++;
        if (index > slideCount - visibleSlides) {
            index = 0; // loop ma fari start
        }
        slider.style.transform = `translateX(-${index * (slides[0].offsetWidth + 15)}px)`;
    }

    setInterval(moveSlider, 2500); // 2.5 sec ma agal move thase
</script>
