...
<section class="shop-category">
    ...
    <div class="container">
        ...
        <div class="category-grid">
            ...
            <a href="{{ route('frontend.product_by_category',['id' => $cat->id]) }}" class="category-item" style="animation-delay: {{ $index * 0.1 }}s;">
...
<style>
    ...
    /* Heading */
    .shop-category .category-heading {
        font-size: 2rem;
        font-weight: 700;
        margin-bottom: 10px;
        color: #222;
    ...
    .shop-category .category-subtitle {
        font-size: 1rem;
        color: #555;
        margin-bottom: 40px;
        max-width: 700px;
