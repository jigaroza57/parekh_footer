...
<!-- Enhanced Explore By Collection Header -->
<div class="header-section">
    <div class="header-content">
        <h2 class="main-title">
            <span class="title-word">Explore</span>
            <span class="title-word">By</span>
            <span class="title-word highlight">Collection</span>
        </h2>
        <div class="title-underline"></div>
        <p class="subtitle">Discover our curated collections crafted with love</p>
    </div>
...
<div class="collections-container">
    <div class="collections-grid">
        ...
        <div class="collection-item" data-delay="{{ $index * 100 }}">
                ...
                <div class="collection-card">
                    ...
                    <div class="card-content">
                        <div class="content-top">
                            <div class="category-badge {{ $index % 3 == 0 ? 'trending' : ($index % 3 == 1 ? 'special' : '') }}">
                                {{ $index % 3 == 0 ? 'Trending' : ($index % 3 == 1 ? 'Special' : 'Featured') }}
                            </div>
                        ...
                        <p class="collection-subtitle">Premium Collection</p>
