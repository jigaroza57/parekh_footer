...
<!---Shop by Category-->
  <!-- Background Elements -->
    ...
    <div class="section-header">
        ...
        <p class="section-subtitle">Discover our curated collections crafted with passion and precision</p>
    </div>

    <!-- Collection Grid -->
    <div class="collection-grid">
        <!-- Collection Card 1 -->
        <div class="collection-card" onclick="handleCardClick(1)">
            <div class="image-container">
                <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&h=300&fit=crop" alt="Premium Collection" class="collection-image">
            ...
            <div class="card-content">
                <h5 class="collection-name">Premium Collection</h5>
                <p class="collection-description">Luxury items crafted with excellence</p>
            </div>
        </div>

        <!-- Collection Card 2 -->
        <div class="collection-card" onclick="handleCardClick(2)">
            <div class="image-container">
                <img src="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=400&h=300&fit=crop" alt="Modern Collection" class="collection-image">
                <div class="image-overlay">
                    <i class="fas fa-eye view-icon"></i>
                </div>
                <div class="collection-badge">Trending</div>
            </div>
            <div class="card-content">
                <h5 class="collection-name">Modern Collection</h5>
                <p class="collection-description">Contemporary designs for modern living</p>
            </div>
        </div>

        <!-- Collection Card 3 -->
        <div class="collection-card" onclick="handleCardClick(3)">
            <div class="image-container">
                <img src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400&h=300&fit=crop" alt="Classic Collection" class="collection-image">
                <div class="image-overlay">
                    <i class="fas fa-eye view-icon"></i>
                </div>
            ...
            <div class="card-content">
                <h5 class="collection-name">Classic Collection</h5>
                <p class="collection-description">Timeless pieces with enduring appeal</p>
            </div>
        </div>

        <!-- Collection Card 4 -->
        <div class="collection-card" onclick="handleCardClick(4)">
            <div class="image-container">
                <img src="https://images.unsplash.com/photo-1560472355-536de3962603?w=400&h=300&fit=crop" alt="Artisan Collection" class="collection-image">
                <div class="image-overlay">
                    <i class="fas fa-eye view-icon"></i>
                </div>
                <div class="collection-badge">Handmade</div>
            </div>
            <div class="card-content">
                <h5 class="collection-name">Artisan Collection</h5>
                <p class="collection-description">Handcrafted treasures by skilled artisans</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        // Handle card clicks
        function handleCardClick(collectionId) {
        ...
        // Add mouse movement parallax to cards
        document.addEventListener('mousemove', (e) => {
            ...
            cards.forEach((card, index) => {
                const xOffset = (x - 0.5) * (10 + index * 2);
                const yOffset = (y - 0.5) * (10 + index * 2);
...
<style>
    ...
    * {
    ...
    .section-title {
        ...
        background: linear-gradient(135deg, #622c2c, #8b4444, #622c2c);
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        background-clip: text;
    ...
    @keyframes titleGlow {
        0% {
            filter: drop-shadow(0 0 10px rgba(98, 44, 44, 0.3));
        }

        100% {
            filter: drop-shadow(0 0 20px rgba(98, 44, 44, 0.6));
        }
    }
    ...
    .image-overlay {
        ...
        right: 0;
        bottom: 0;
        background: linear-gradient(135deg, rgba(98, 44, 44, 0.3), rgba(0, 0, 0, 0.5));
        opacity: 0;
        transition: all 0.4s ease;
        display: flex;
        align-items: center;
    ...
    .collection-card:hover .view-icon {
    ...
    .collection-badge {
        ...
        top: 1rem;
        right: 1rem;
        background: linear-gradient(135deg, #622c2c, #8b4444);
        color: #fff;
        padding: 0.5rem 1rem;
        border-radius: 25px;
        font-size: 0.8rem;
