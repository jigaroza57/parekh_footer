...
<style>
    ...
    .banner-overlay {
        ...
        width: 100%;
        height: 100%;
        background: url("{{ asset('images/new/triangle.svg') }}") no-repeat center;
...
<div class="" style="display: flex;">
    <img src="{{ asset('images/new/banner_1.jpg')}}" class="img-fluid" alt="">
    <img src="{{ asset('images/new/banner_2.jpg')}}" class="img-fluid" alt="">
    <img src="{{ asset('images/new/banner_3.jpg')}}" class="img-fluid" alt="">
    <img src="{{ asset('images/new/banner_4.jpg')}}" class="img-fluid" alt="">
