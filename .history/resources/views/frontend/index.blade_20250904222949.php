...
<style>
    ...
    /* SVG overlay at the top with reduced opacity */
    .banner-overlay {
        position: absolute;
        top: 0;
        left: 0;
        ...
        background: url("{{ asset('images/new/triangle.svg') }}") no-repeat top center,
        url("{{ asset('images/new/triangle.svg') }}") no-repeat bottom center;
