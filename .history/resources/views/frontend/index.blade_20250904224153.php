...
<style>
    ...
    /* overlay svg positioning */
    .banner-card svg.overlay-shape {
        position: absolute;
        left: 0;
        width: 100%;
        height: 100px;
        /* overlay height control */
        z-index: 1;
        pointer-events: none;
        opacity: 0.5;
    }
    ...
    /* top shape */
    .banner-card svg.overlay-top {
        top: 0;
    }

    /* bottom shape */
    .banner-card svg.overlay-bottom {
        bottom: 0;
        transform: rotate(180deg);
        /* simple rotate so same path works for bottom */
    }
    ...
    .banner-card:hover img.main-img {
        transform: scale(1.1);
    }
</style>
...
<div class="banner-section">
    <div class="banner-card">
        <img class="main-img" src="{{ asset('images/new/banner_1.jpg')}}" alt="">
        <!-- overlay from TOP -->

         <img class=" overlay-shape overlay-top" src="{{ asset('images/new/triangle.svg')}}" alt="">
        <!-- <svg class="overlay-shape overlay-top" viewBox="0 0 800 100" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0,100 C200,0 600,200 800,100 L800,0 L0,0 Z" fill="black" fill-opacity="0.2" />
        </svg> -->
    ...
    <div class="banner-card">
        <img class="main-img" src="{{ asset('images/new/banner_2.jpg')}}" alt="">
        <!-- overlay from BOTTOM -->
         <img class="overlay-shape overlay-bottom" src="{{ asset('images/new/triangle.svg')}}" alt="">
    ...
    <div class="banner-card">
        <img class="main-img" src="{{ asset('images/new/banner_3.jpg')}}" alt="">
        <!-- overlay from TOP again -->
               <img class=" overlay-shape overlay-top" src="{{ asset('images/new/triangle.svg')}}" alt="">
    ...
    <div class="banner-card">
        <img class="main-img" src="{{ asset('images/new/banner_4.jpg')}}" alt="">
        <!-- overlay from BOTTOM again -->
        <svg class="overlay-shape overlay-bottom" viewBox="0 0 800 100" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0,100 C200,0 600,200 800,100 L800,0 L0,0 Z" fill="black" fill-opacity="0.2" />
        </svg>
        <div class="banner-text2">
