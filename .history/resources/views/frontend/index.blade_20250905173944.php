...
<style>
    ...
    bottom: 0;
    left: 0;
    width: 100%;    /* full width ma spread */
    height: auto;
    opacity: 0.8;   /* tamari requirement pramane */
    pointer-events: none; /* clicks block na kare */
    z-index: 2;     /* overlay karta upar/dichhe rakhi shako */
}
</style>
...
<div class="banner-section">
    ...
    <div class="banner-card">
        ...
        <img src="{{ asset('images/new/bottom-shape.svg')}}" alt="" class="banner-bottom-svg">
    ...
    <div class="banner-card">
        ...
        <img src="{{ asset('images/new/bottom-shape.svg')}}" class="banner-svg bottom" alt="">
