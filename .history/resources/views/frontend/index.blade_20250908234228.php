...
<div class="text-center my-5">
    <div class="header-decoration">
        <h2 style="font-family: 'Aladin', system-ui; font-size: 2.8rem; color: #622c2c; text-transform: uppercase; position: relative; display: inline-block;">
...
<div class="container">
    <div class="row justify-content-center g-4">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <a href="#" class="collection-card">
                <div class="collection-wrapper">
                    <img src="https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=400&h=400&fit=crop" alt="Luxury Collection">
                    <div class="collection-overlay">
                        <div class="collection-badge">NEW</div>
                        <div class="collection-content">
                            <h5>Luxury Collection</h5>
                            <span class="collection-subtitle">Premium Quality</span>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <a href="#" class="collection-card">
                <div class="collection-wrapper">
                    <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=400&h=400&fit=crop" alt="Modern Collection">
                    <div class="collection-overlay">
                        <div class="collection-badge trending">HOT</div>
                        <div class="collection-content">
                            <h5>Modern Collection</h5>
                            <span class="collection-subtitle">Contemporary Style</span>
                            <div class="collection-arrow">
                                <i class="fas fa-arrow-right"></i>
                            </div>
                        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <a href="#" class="collection-card">
                <div class="collection-wrapper">
                    <img src="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=400&h=400&fit=crop" alt="Classic Collection">
                    <div class="collection-overlay">
                        <div class="collection-badge classic">BEST</div>
                        <div class="collection-content">
                            <h5>Classic Collection</h5>
                            <span class="collection-subtitle">Timeless Elegance</span>
                            <div class="collection-arrow">
                                <i class="fas fa-arrow-right"></i>
                            </div>
                        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <a href="#" class="collection-card">
                <div class="collection-wrapper">
                    <img src="https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=400&h=400&fit=crop" alt="Exclusive Collection">
                    <div class="collection-overlay">
                        <div class="collection-badge exclusive">VIP</div>
                        <div class="collection-content">
                            <h5>Exclusive Collection</h5>
                            <span class="collection-subtitle">Limited Edition</span>
                            <div class="collection-arrow">
                                <i class="fas fa-arrow-right"></i>
                            </div>
                        </div>
...
<style>
    ...
    .header-underline {
        ...
        width: 80px;
        height: 3px;
        background: linear-gradient(90deg, #622c2c, #d4a574);
        border-radius: 2px;
    }
    ...
    .collection-wrapper:hover {
        ...
        box-shadow: 
            0 25px 50px rgba(98, 44, 44, 0.25),
    ...
    .collection-badge {
        ...
        top: 20px;
        right: 20px;
        background: linear-gradient(135deg, #622c2c, #8b4d4d);
        color: white;
        padding: 6px 12px;
        border-radius: 20px;
        font-size: 0.7rem;
    ...
    .collection-wrapper:hover .collection-badge {
        transform: translateX(0);
        opacity: 1;
    }
    ...
    .collection-wrapper:hover .collection-arrow i {
        transform: translateX(0);
        opacity: 1;
    }
    ...
    .collection-wrapper:hover .collection-overlay {
        background: linear-gradient(
            to top, 
            rgba(98, 44, 44, 0.9) 0%,
            rgba(98, 44, 44, 0.7) 50%,
            rgba(98, 44, 44, 0.3) 80%,
            transparent 100%
        );
    }
    ...
    .collection-wrapper:hover::before {
        transform: translateX(100%);
    }
</style>
