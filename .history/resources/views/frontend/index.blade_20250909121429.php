...
<link href="https://fonts.googleapis.com/css2?family=Aladin&family=Inter:wght@300;400;500;600;700&family=Playfair+Display:wght@400;500;600;700&display=swap" rel="stylesheet">
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" rel="stylesheet">

<!-- Explore By Collection Header -->
<div class="explore-header">
    <h2>Explore By Collection</h2>
    <p class="subtitle">Discover our curated collections of premium products</p>
    <div class="decorative-icon">
        <img src="{{ asset('images/group-48099402.svg') }}" class="decorative-svg" alt="Decorative Icon">
    </div>
</div>
...
<div class="collection-container">
    <div class="collection-grid">
        ...
        <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="collection-card" style="animation-delay: {{ ($index * 0.1) + 0.1 }}s;">
            <div class="collection-wrapper">
                ...
                <div class="corner-accent">
                    <i class="fas fa-{{ $loop->first ? 'crown' : ($loop->iteration % 4 == 0 ? 'diamond' : ($loop->iteration % 3 == 0 ? 'medal' : 'star')) }}"></i>
                </div>
            </div>
        </a>
        @endforeach
...
<style>
    * {
    ...
    .explore-header h2 {
        ...
        font-size: 3.5rem;
        background: linear-gradient(45deg, #622c2c, #8b4513, #d4af37);
        background-size: 200% 200%;
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        background-clip: text;
    ...
    .collection-wrapper:hover .collection-overlay::before {
        opacity: 1;
    }
    ...
    .collection-wrapper:hover .collection-overlay h5 {
        transform: translateY(0);
        opacity: 1;
    }
    ...
    .collection-wrapper:hover .view-collection {
        transform: translateY(0);
        opacity: 1;
    }
    ...
    .collection-wrapper:hover .view-collection i {
    ...
    .collection-wrapper:hover .corner-accent {
        opacity: 1;
        transform: scale(1);
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.collection-card').forEach(card => {
        card.addEventListener('mouseenter', function() {
            // Add subtle scale animation to other cards
            document.querySelectorAll('.collection-card').forEach(otherCard => {
                if (otherCard !== this) {
        ...
        card.addEventListener('click', function(e) {
            ...
            const wrapper = this.querySelector('.collection-wrapper');
