...
<div class="container my-5">
    <h2 class="collection-heading text-center">🔥 Trending Collections 🔥</h2>
    <div class="row g-4 align-items-stretch">
        
        <!-- Featured Big Card -->
        <div class="col-lg-6">
            <a href="{{ route('frontend.product_detail',['id'=>$collection[0]->id]) }}" class="feature-card">
                <img src="{{ asset('images/product/'.$collection[0]->image) }}" alt="{{ $collection[0]->name }}">
        ...
        <div class="col-lg-6">
            <div class="row g-4">
                @foreach($collection->slice(1,4) as $coll)
                <div class="col-md-6">
                    <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="mini-card">
