...
<div class="container my-5">
    ...
    <h2 class="collection-heading text-center">🌟 Discover Unique Collections 🌟</h2>
    <p class="collection-subheading text-center">Handpicked designs to inspire your lifestyle.</p>
