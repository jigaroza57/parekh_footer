...
<div class="container my-5">
    <h2 class="collection-heading text-center">✨ Curated Lifestyle ✨</h2>
    <p class="collection-subheading text-center">Not just products — experiences designed for you.</p>

    <div class="magazine-grid">
        @foreach($collection as $index => $coll)
        <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}"
            class="magazine-item {{ $index % 5 == 0 ? 'magazine-hero' : '' }}">
...
<style>
    ...
    /* Big hero card every 5th item */
    .magazine-item.magazine-hero {
        grid-column: span 4;
        grid-row: span 2;
    }
