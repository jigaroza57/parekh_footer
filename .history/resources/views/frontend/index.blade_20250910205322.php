...
<div class="container my-5">
    <h2 class="collection-heading text-center">✨ Explore Our Collections ✨</h2>
    <p class="collection-subheading text-center">Curated pieces crafted to elevate your lifestyle.</p>

    <div class="creative-masonry">
        @foreach($collection as $coll)
        <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="creative-item">
