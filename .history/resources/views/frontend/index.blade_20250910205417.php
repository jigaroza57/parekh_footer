...
<div class="container my-5">
    <h2 class="collection-heading text-center">💎 Premium Collections 💎</h2>
    <p class="collection-subheading text-center">Step into a world of style & creativity.</p>

    <div class="glow-grid">
        @foreach($collection as $coll)
        <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="glow-item">
            <div class="glow-card">
...
<style>
    ...
    .glow-border {
        ...
        border-radius: 22px;
        padding: 2px;
        background: linear-gradient(135deg, #ff6ec7, #7366ff, #20e3b2);
        filter: blur(8px);
        opacity: 0.7;
        z-index: 0;
    ...
    .glow-card:hover .glow-image img {
