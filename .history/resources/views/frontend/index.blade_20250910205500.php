...
<div class="container my-5">
    ...
    <p class="collection-subheading text-center">Discover handpicked designs crafted to inspire you.</p>

    <div class="trend-grid">
        @foreach($collection as $coll)
        <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="trend-item">
