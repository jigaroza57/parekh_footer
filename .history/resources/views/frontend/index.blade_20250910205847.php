...
<div class="container my-5">
    <h2 class="collection-heading text-center">✨ Discover Our Exclusive Collections ✨</h2>
    <p class="collection-subheading text-center">Handpicked treasures to inspire your style.</p>

    <div class="masonry-grid">
        @foreach($collection as $coll)
        <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="masonry-item">
            <div class="masonry-card">
                <div class="image-wrapper">
                    <img src="{{ asset('images/product/'.$coll->image) }}" alt="{{ $coll->name }}" class="masonry-img">
                    <div class="overlay"></div>
                </div>
                <div class="masonry-info">
                    <h5>{{ $coll->name }}</h5>
                    <span class="view-more">Explore Now <i class="fas fa-arrow-right"></i></span>
                </div>
            </div>
        </a>
        @endforeach
...
<style>
    ...
    .collection-heading {
        ...
        text-transform: uppercase;
        margin-bottom: 1rem;
        background: linear-gradient(90deg, #ff6f61, #6b7280);
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
    }
    ...
    .masonry-card:hover .view-more i {
