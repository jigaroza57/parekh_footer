...
<div class="text-center my-5">
    <h2 class="collection-heading-new">Explore Our Collections</h2>
    <p class="collection-subheading-new">Discover curated pieces designed to elevate your everyday style.</p>
</div>

<div class="collection-carousel-wrapper">
    <button class="carousel-arrow left" id="carouselPrev"><i class="bi bi-chevron-left"></i></button>
        ...
        <div class="carousel-card">
            ...
            <div class="carousel-card-glass">
                <div class="carousel-card-content">
                    <h5>{{ $coll->name }}</h5>
                    <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="carousel-view-btn">
    ...
    <button class="carousel-arrow right" id="carouselNext"><i class="bi bi-chevron-right"></i></button>
</div>

<style>
    /* Creative Carousel Styles */
    .collection-heading-new {
        font-family: 'Playfair Display', serif;
        font-size: 3rem;
        color: #581E1E;
        letter-spacing: 2px;
        margin-bottom: 0.5rem;
        background: linear-gradient(90deg, #ffd700, #ff6b6b, #581E1E, #ffd700);
        background-size: 200% 200%;
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
    ...
    .carousel-card {
        ...
        border-radius: 24px;
        overflow: hidden;
        box-shadow: 0 8px 32px rgba(88,30,30,0.12), 0 1.5px 0 rgba(255,215,0,0.08);
    ...
    .carousel-card:hover {
        ...
        box-shadow: 0 16px 48px rgba(88,30,30,0.18), 0 0 0 4px #ffd70044;
        border-image: linear-gradient(120deg, #ffd700 30%, #ff6b6b 70%, #581E1E 100%) 1;
    }
    .carousel-card-bg {
        position: absolute;
        inset: 0;
    ...
    .carousel-card:hover .carousel-card-bg {
        filter: blur(2px) brightness(1) saturate(1.3);
    }
    .carousel-card-glass {
        position: absolute;
        inset: 0;
    ...
    .carousel-card-content {
        ...
        background: linear-gradient(0deg, rgba(88,30,30,0.85) 60%, rgba(255,255,255,0.01) 100%);
    ...
    .carousel-card-content h5 {
        ...
        letter-spacing: 1px;
        color: #ffd700;
        text-shadow: 0 2px 8px #581E1E33;
    }
    .carousel-view-btn {
        display: inline-flex;
        align-items: center;
        gap: 8px;
        padding: 10px 22px;
        background: linear-gradient(90deg, #ffd700 60%, #ff6b6b 100%);
        color: #581E1E;
        font-weight: 600;
        border-radius: 24px;
        font-size: 1rem;
    ...
    .carousel-view-btn:hover {
        background: linear-gradient(90deg, #ff6b6b 40%, #ffd700 100%);
        color: #fff;
    ...
    @media (max-width: 900px) {
        .carousel-card { min-width: 240px; max-width: 260px; height: 320px; }
        .carousel-card-content { padding: 20px 14px 16px 14px; }
        .collection-carousel-wrapper { padding: 0 10px; }
    }
    @media (max-width: 600px) {
        .carousel-card { min-width: 180px; max-width: 200px; height: 220px; }
        .carousel-card-content h5 { font-size: 1rem; }
        .carousel-view-btn { font-size: 0.85rem; padding: 7px 14px; }
