...
<div class="collections-hero">
    ...
    <div class="text-center position-relative">
        ...
        <h2 class="collection-heading">
            <span class="word-1">Explore</span>
            <span class="word-2">Our Collections</span>
        </h2>
...
<div class="container-fluid collections-wrapper">
    <div class="collections-grid">
        ...
        <div class="collection-item {{ $index == 0 ? 'featured-item' : '' }} {{ $index % 3 == 1 ? 'elevated-item' : '' }}">
            <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="collection-link">
                <div class="collection-card">
                    ...
                    <div class="image-container">
                        <img src="{{ asset('images/product/'.$coll->image) }}" alt="{{ $coll->name }}" class="collection-image">
                    ...
                    <div class="collection-content">
                        <div class="collection-category">Collection</div>
                        <h3 class="collection-name">{{ $coll->name }}</h3>
                        <div class="collection-action">
                            <span class="action-text">Explore Now</span>
...
<style>
    ...
    .float-1 {
        width: 200px;
        height: 200px;
        background: linear-gradient(45deg, #7A4C4C, #D9B08C);
        top: 10%;
        left: -5%;
        animation-delay: 0s;
    }
    ...
    .float-2 {
        width: 150px;
        height: 150px;
        background: linear-gradient(45deg, #D9B08C, #A38F8F);
        top: 60%;
        right: -3%;
        animation-delay: -2s;
    }
    ...
    .float-3 {
        width: 100px;
        height: 100px;
        background: linear-gradient(45deg, #A38F8F, #7A4C4C);
        top: 30%;
        right: 15%;
        animation-delay: -4s;
    }
    ...
    .collection-badge {
        ...
        font-weight: 500;
        margin-bottom: 30px;
        box-shadow: 0 8px 32px rgba(122, 76, 76, 0.3);
        position: relative;
        overflow: hidden;
    }
    ...
    .word-2 {
        display: block;
        background: linear-gradient(45deg, #D9B08C, #7A4C4C);
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        background-clip: text;
        opacity: 0;
    ...
    .pattern-2 {
        ...
        bottom: 20%;
        right: 15%;
        animation: patternFloat 4s ease-in-out infinite reverse;
    }
    ...
    .card-glow {
        ...
        right: -50%;
        bottom: -50%;
        background: radial-gradient(circle, rgba(217, 176, 140, 0.1) 0%, transparent 70%);
        opacity: 0;
    ...
    .collection-card:hover .image-patterns {
        opacity: 1;
    }
    ...
    .collection-card:hover .action-icon {
        transform: translateX(5px);
        box-shadow: 0 5px 15px rgba(122, 76, 76, 0.4);
    }
