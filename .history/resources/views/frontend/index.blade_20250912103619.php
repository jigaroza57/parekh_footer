...
<div class="creative-collection-section py-5">
    <div class="container">
        ...
        <div class="creative-collection-grid">
            @foreach($collection as $index => $coll)
            <div class="creative-collection-card" style="animation-delay: {{ $index * 0.1 }}s;">
                <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="creative-collection-link">
                    ...
                    <div class="creative-card-info">
                        ...
                        <span class="creative-view-more">
                            View Collection
                            <svg width="22" height="22" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h12M13 8l4 4-4 4"/></svg>
                        </span>
                    </div>
...
<style>
    ...
    .creative-collection-section {
        background: linear-gradient(120deg, #fff7f0 0%, #f8e7e0 100%);
        position: relative;
        overflow: hidden;
    }
    ...
    .creative-collection-heading::after {
        content: '';
        display: block;
        width: 90px;
        height: 4px;
        background: linear-gradient(90deg, #F8BA4B, #7A4C4C);
        margin: 16px auto 0;
        border-radius: 2px;
    }
    .creative-collection-subheading {
    ...
    .creative-collection-card {
        ...
        overflow: visible;
        min-height: 380px;
        box-shadow: 0 8px 32px rgba(88,30,30,0.10), 0 1.5px 8px rgba(248,186,75,0.08);
    ...
    .creative-collection-card:hover {
        ...
        box-shadow: 0 16px 48px rgba(88,30,30,0.18), 0 2px 12px rgba(248,186,75,0.12);
        z-index: 3;
    }
    ...
    .creative-card-bg {
        ...
        right: -18px;
        bottom: -18px;
        background: linear-gradient(135deg, #f8ba4b22 0%, #7a4c4c11 100%);
        border-radius: 32px;
        z-index: 0;
        filter: blur(8px);
        opacity: 0.7;
    ...
    .creative-card-img {
        ...
        box-shadow: 0 4px 24px rgba(88,30,30,0.10);
        position: relative;
        z-index: 2;
        transition: transform 0.5s cubic-bezier(.23,1.01,.32,1), filter 0.4s;
    }
    ...
    .creative-card-info {
        ...
        z-index: 3;
        color: #fff;
        text-shadow: 0 2px 12px rgba(88,30,30,0.18);
    }
    ...
    .creative-view-more {
        ...
        gap: 8px;
        font-size: 1rem;
        background: rgba(88,30,30,0.85);
        padding: 7px 18px 7px 14px;
        border-radius: 20px;
        font-weight: 500;
        box-shadow: 0 2px 8px rgba(248,186,75,0.10);
    ...
    @media (max-width: 900px) {
        .creative-card-img { height: 220px; }
        .creative-card-info { left: 14px; bottom: 18px; }
    }
    @media (max-width: 600px) {
        .creative-collection-heading { font-size: 2rem; }
        .creative-card-img { height: 150px; }
        .creative-card-info h5 { font-size: 1.1rem; }
        .creative-collection-grid { gap: 18px; }
    }
    @keyframes fadeInUp {
