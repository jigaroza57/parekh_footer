...
<style>
    ...
    .creative-collection-card:nth-child(odd) {
        margin-top: 40px;
    }
    ...
    .creative-collection-card:hover .creative-card-bg {
        opacity: 1;
    }
    ...
    .creative-collection-card:hover .creative-card-shape {
        opacity: 0.6;
    }
