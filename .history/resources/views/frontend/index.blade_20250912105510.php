    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="collection-link">
                <div class="collection-card-creative">
                    <img src="{{ asset('images/product/'.$coll->image) }}" alt="{{ $coll->name }}">
                    <div class="collection-overlay-creative">
                        <div class="collection-info-creative">
                            <h5 class="mb-2">{{ $coll->name }}</h5>
                            <span class="view-more-creative">View Collection</span>
                        </div>
                    </div>
                </div>
            </a>
...
<style>
    ...
    /* Hover Effects - Dynamic and Awesome */
    .collection-link:hover .collection-card-creative {
        transform: translateY(-8px) rotate(1deg);
        /* હળવું રોટેશન */
        box-shadow: 0 15px 40px rgba(0, 0, 0, 0.15);
    }

    .collection-link:hover .collection-card-creative img {
        transform: scale(1.05);
        filter: grayscale(0%);
        /* ગ્રેસ્કેલથી રંગીન થાય */
    }

    .collection-link:hover .collection-overlay-creative {
        opacity: 1;
    }

    .collection-link:hover .collection-info-creative {
        transform: translateY(0);
        opacity: 1;
    }

    .collection-link:hover .view-more-creative {
