...
<section class="collection-section position-relative py-5">
    ...
    <div class="container py-5">
        <div class="text-center mb-5">
            ...
            <p class="collection-subheading">Discover curated pieces designed to elevate your everyday style with timeless elegance.</p>
        </div>
...
<style>
    ...
    .collection-card::before {
        ...
        width: 100%;
        height: 100%;
        background: linear-gradient(135deg, rgba(122, 76, 76, 0.4) 0%, rgba(217, 176, 140, 0.2) 100%);
        opacity: 0;
        z-index: 2;
        transition: var(--transition);
    }
    ...
    .collection-link:hover .collection-card::before {
        opacity: 1;
    }
    ...
    .collection-link:hover .collection-info {
        transform: translateY(0);
    }
    ...
    .collection-link:hover .collection-count {
        opacity: 1;
        transform: translateY(0);
    }
