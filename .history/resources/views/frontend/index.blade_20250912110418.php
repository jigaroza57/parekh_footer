...
<div class="collections-container">
    <div class="section-header">
        ...
        <p class="section-subtitle">Discover curated pieces designed to elevate your everyday style with timeless elegance and modern sophistication.</p>
    </div>
    ...
    <div class="collections-grid">
        ...
        <div class="collection-item item-large">
            <img src="https://images.unsplash.com/photo-1558769132-cb1aea458c5e?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Luxury Collection" class="collection-image">
            <div class="collection-overlay"></div>
            <div class="collection-content">
                <h3 class="collection-title">Luxury Edition</h3>
                <p class="collection-desc">Premium materials crafted for those who appreciate the finer details in life.</p>
                <a href="#" class="collection-cta">Explore <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>

        <!-- Medium Collection Items -->
        <div class="collection-item item-medium">
            <img src="https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Casual Wear" class="collection-image">
            <div class="collection-overlay"></div>
            <div class="collection-content">
                <h3 class="collection-title">Casual Essentials</h3>
                <p class="collection-desc">Comfortable yet stylish pieces for your everyday adventures.</p>
                <a href="#" class="collection-cta">Explore <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>

        <div class="collection-item item-medium">
            <img src="https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Formal Attire" class="collection-image">
            <div class="collection-overlay"></div>
            <div class="collection-content">
                <h3 class="collection-title">Formal Elegance</h3>
                <p class="collection-desc">Sophisticated designs for those special occasions and professional settings.</p>
                <a href="#" class="collection-cta">Explore <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>

        <!-- Small Collection Items -->
        <div class="collection-item item-small">
            <img src="https://images.unsplash.com/photo-1525299374597-911581e1bdef?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Accessories" class="collection-image">
            <div class="collection-overlay"></div>
            <div class="collection-content">
                <h3 class="collection-title">Accessories</h3>
                <p class="collection-desc">The perfect finishing touches to complete any outfit.</p>
                <a href="#" class="collection-cta">View <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>

        <div class="collection-item item-small">
            <img src="https://images.unsplash.com/photo-1536678891919-e0e7d61a4b15?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Footwear" class="collection-image">
            <div class="collection-overlay"></div>
            <div class="collection-content">
                <h3 class="collection-title">Footwear</h3>
                <p class="collection-desc">Step out in style with our exclusive shoe collection.</p>
                <a href="#" class="collection-cta">View <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>

        <div class="collection-item item-small">
            <img src="https://images.unsplash.com/photo-1582142306909-195724d3a58c?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Seasonal Collection" class="collection-image">
            <div class="collection-overlay"></div>
            <div class="collection-content">
                <h3 class="collection-title">Seasonal</h3>
                <p class="collection-desc">Weather-appropriate styles for every season of the year.</p>
                <a href="#" class="collection-cta">View <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>

        <div class="collection-item item-small">
            <img src="https://images.unsplash.com/photo-1519457431-44ccd64a579b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" alt="Limited Edition" class="collection-image">
            <div class="collection-overlay"></div>
            <div class="collection-content">
                <h3 class="collection-title">Limited Edition</h3>
                <p class="collection-desc">Exclusive pieces for the true fashion connoisseur.</p>
                <a href="#" class="collection-cta">View <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </div>
...
<style>
    ...
    .collection-item:hover .collection-desc {
        opacity: 1;
        max-height: 100px;
    }
