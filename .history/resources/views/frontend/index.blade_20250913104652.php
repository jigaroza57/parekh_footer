...
<div class="text-center my-5">
    ...
    <p class="collection-subheading">Curated pieces crafted to inspire your style journey.</p>
</div>
    ...
    <div class="row g-4">
        ...
        <div class="col-12">
            <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="collection-link">
                <div class="collection-split d-flex flex-column flex-md-row {{ $index % 2 == 0 ? '' : 'flex-md-row-reverse' }}">
                    <div class="split-img">
                        <img src="{{ asset('images/product/'.$coll->image) }}" alt="{{ $coll->name }}">
                    </div>
                    <div class="split-text">
                        <h2>{{ $coll->name }}</h2>
                        <p>Discover timeless pieces designed to elevate your everyday look.</p>
                        <button class="btn-discover">View Collection <i class="bi bi-arrow-right"></i></button>
                    </div>
                </div>
            </a>
        </div>
...
<style>
    ...
    /* Hover Effects */
    .collection-link:hover .collection-card-alt {
        transform: translateY(-10px) scale(1.02);
        box-shadow: 0 18px 35px rgba(0, 0, 0, 0.25);
    }

    .collection-link:hover .collection-card-alt img {
        transform: scale(1.12);
    }

    .collection-link:hover .view-more-alt {
        transform: translateX(6px);
        opacity: 1;
    }

    .collection-link:hover .view-more-alt i {
