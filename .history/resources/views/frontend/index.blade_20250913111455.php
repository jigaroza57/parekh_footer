    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="collection-link">
                <div class="collection-card" data-images='@json($coll->sub_images)'>
                    <img src="{{ asset('images/product/'.$coll->image) }}" alt="{{ $coll->name }}" class="main-img">
...
<style>
    ...
    .collection-link:hover .collection-card {
        transform: scale(1.05);
        box-shadow: 0 0 25px rgba(122, 76, 76, 0.8);
    }
...
<script>
    document.querySelectorAll('.collection-card').forEach(card => {
        let img = card.querySelector('.main-img');
        ...
        card.addEventListener('mouseenter', () => {
            if (images.length > 0) {
                interval = setInterval(() => {
                    ...
                    img.src = "/images/product/" + images[index];
                }, 1500);
            }
        });
