...
<div class="collections-glass-section">
    <h2 class="collections-glass-title">Explore Our Collections</h2>
    <p class="collections-glass-subtitle">Discover curated pieces designed to elevate your everyday style.</p>
    <div class="collections-glass-scroll">
        @foreach($collection as $coll)
        <div class="collections-glass-card">
            <div class="collections-glass-img-wrap">
                <img src="{{ asset('images/product/'.$coll->image) }}" alt="{{ $coll->name }}">
                <div class="collections-glass-blur"></div>
            </div>
            <div class="collections-glass-info">
                <h5>{{ $coll->name }}</h5>
                <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="collections-glass-btn">
...
<style>
    ...
    .collections-glass-section {
        padding: 80px 0 60px 0;
        background: linear-gradient(120deg, #f8f6f4 60%, #f3e9e2 100%);
        text-align: center;
        overflow-x: hidden;
        position: relative;
    }
    .collections-glass-title {
    ...
    .collections-glass-scroll {
        ...
        scrollbar-color: #c471f5 #f8f6f4;
    }
    .collections-glass-scroll::-webkit-scrollbar {
        height: 8px;
    }
    .collections-glass-scroll::-webkit-scrollbar-thumb {
        background: #c471f5;
        border-radius: 4px;
    }
    .collections-glass-card {
        min-width: 320px;
        max-width: 340px;
        background: rgba(255,255,255,0.25);
        border-radius: 24px;
        box-shadow: 0 8px 32px rgba(80,30,80,0.12);
        backdrop-filter: blur(10px);
        border: 1.5px solid rgba(200,113,245,0.12);
        overflow: hidden;
        position: relative;
    ...
    .collections-glass-card:hover {
        transform: translateY(-18px) scale(1.04) rotate(-1deg);
        box-shadow: 0 16px 40px rgba(200,113,245,0.18), 0 2px 8px rgba(0,0,0,0.08);
        z-index: 2;
    }
    @keyframes floatCard {
    ...
    .collections-glass-img-wrap {
        position: relative;
        width: 100%;
        height: 260px;
        overflow: hidden;
    }
    .collections-glass-img-wrap img {
        width: 100%;
        height: 100%;
        object-fit: cover;
    ...
    .collections-glass-card:hover .collections-glass-img-wrap img {
    ...
    .collections-glass-blur {
        position: absolute;
        inset: 0;
        background: linear-gradient(180deg,rgba(255,255,255,0) 60%,rgba(200,113,245,0.12) 100%);
        pointer-events: none;
        transition: opacity 0.5s;
        opacity: 0.6;
    }
    .collections-glass-info {
        padding: 28px 24px 24px 24px;
        text-align: left;
        position: relative;
        z-index: 2;
    }
    .collections-glass-info h5 {
        font-family: 'Montserrat', serif;
        font-size: 1.35rem;
        font-weight: 700;
        color: #7a4c4c;
    ...
    .collections-glass-card:hover .collections-glass-info h5 {
        color: #c471f5;
    }
    .collections-glass-btn {
        display: inline-flex;
        align-items: center;
        gap: 10px;
        ...
        border-radius: 30px;
        text-decoration: none;
        box-shadow: 0 2px 12px rgba(200,113,245,0.08);
    ...
    .collections-glass-btn:hover {
        background: linear-gradient(90deg,#fa71cd,#c471f5);
        transform: translateX(4px) scale(1.06);
    }
    .collections-glass-btn svg {
        margin-left: 2px;
        transition: transform 0.3s;
    }
    .collections-glass-btn:hover svg {
    ...
    @media (max-width: 600px) {
        .collections-glass-title { font-size: 2rem;}
        .collections-glass-card { min-width: 85vw; max-width: 90vw;}
        .collections-glass-img-wrap { height: 140px;}
        .collections-glass-info { padding: 18px 12px 16px 12px;}
    }
</style>
