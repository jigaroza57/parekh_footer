...
<div class="text-center my-5">
    <h2 class="collection-heading">Our Latest Collections</h2>
    <p class="collection-subheading">Handpicked styles, crafted for modern elegance.</p>
</div>
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="collection-link">
                <div class="collection-card new-style">
...
<style>
    ...
    .collection-heading {
        font-size: 2.8rem;
        font-weight: 800;
        background: linear-gradient(90deg, #ff7eb3, #ff758c, #ffae70);
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
        letter-spacing: 2px;
    }
    ...
    /* Hover Effects */
    .collection-card.new-style:hover {
        transform: rotateX(10deg) rotateY(-6deg) scale(1.05);
        box-shadow: 0 20px 45px rgba(0, 0, 0, 0.3);
    }

    .collection-card.new-style:hover img {
        transform: scale(1.2) rotate(-1deg);
    }

    .collection-card.new-style:hover .glass-overlay {
        opacity: 1;
    }

    .collection-card.new-style:hover .collection-info {
        transform: translateY(0);
        opacity: 1;
    }

    .collection-card.new-style:hover .view-more i {
