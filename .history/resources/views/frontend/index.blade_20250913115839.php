...
<br>
<!---Shop by Category-->
<!-- Explore By Collection - Unique Carousel Design -->
<section class="collections-carousel-section py-5">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="collections-carousel-title">Explore Our Collections</h2>
            <p class="collections-carousel-subtitle">Unveil exclusive pieces crafted for your signature style.</p>
        </div>
        <div class="collections-carousel-wrapper">
            <button class="carousel-arrow left" id="carouselLeft"><i class="bi bi-chevron-left"></i></button>
            <div class="collections-carousel" id="collectionsCarousel">
                @foreach($collection as $coll)
                <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="carousel-card">
                    <div class="carousel-card-bg" style="background-image: url('{{ asset('images/product/'.$coll->image) }}');"></div>
                    <div class="carousel-card-glass"></div>
                    <div class="carousel-card-content">
                        <h5>{{ $coll->name }}</h5>
                        <span class="carousel-view-link">
            ...
            <button class="carousel-arrow right" id="carouselRight"><i class="bi bi-chevron-right"></i></button>
        </div>
    </div>
</section>
...
<style>
    ...
    .collections-carousel-section {
        background: linear-gradient(120deg, #fff7f0 0%, #f3e8ff 100%);
        position: relative;
        overflow: hidden;
    }
    ...
    .collections-carousel-title::after {
        content: '';
        display: block;
        margin: 12px auto 0;
        width: 90px;
        height: 4px;
        border-radius: 2px;
        background: linear-gradient(90deg, #ffb347, #a18cd1);
    }
    .collections-carousel-subtitle {
    ...
    .carousel-card {
        ...
        position: relative;
        overflow: hidden;
        box-shadow: 0 8px 32px rgba(90,45,130,0.10), 0 1.5px 8px rgba(255,179,71,0.08);
        display: flex;
    ...
    .carousel-card-content {
        ...
        width: 100%;
        color: #fff;
        text-shadow: 0 2px 12px rgba(90,45,130,0.18);
        display: flex;
    ...
    .carousel-view-link {
        ...
        font-weight: 600;
        color: #ffb347;
        background: rgba(90,45,130,0.13);
        padding: 8px 18px;
        border-radius: 18px;
        display: inline-flex;
        align-items: center;
    ...
    .carousel-card:hover {
        ...
        box-shadow: 0 16px 48px rgba(90,45,130,0.18), 0 2px 16px rgba(255,179,71,0.12);
    }
    .carousel-card:hover .carousel-card-bg {
        transform: scale(1.08) rotate(1deg);
        filter: brightness(0.85) blur(1px);
    }
    .carousel-card:hover .carousel-card-glass {
        opacity: 0.95;
    }
    .carousel-card:hover .carousel-view-link {
        background: #ffb347;
        color: #5a2d82;
    }
    .carousel-arrow {
    ...
    @media (max-width: 1200px) {
        .carousel-card { min-width: 260px; max-width: 270px; height: 340px; }
        .carousel-card-content { padding: 22px 16px 24px; }
        .collections-carousel-title { font-size: 2.1rem; }
    }
    @media (max-width: 768px) {
        .collections-carousel-wrapper { padding: 0 10px; }
        .carousel-arrow { width: 38px; height: 38px; font-size: 1.3rem; }
        .carousel-card { min-width: 200px; max-width: 210px; height: 240px; }
        .carousel-card-content h5 { font-size: 1.1rem; }
        .collections-carousel-title { font-size: 1.3rem; }
    }
</style>
