...
<!-- Explore Collections - Modern Design -->
<div class="text-center my-5">
    <h2 class="new-collection-heading">Our Curated Collections</h2>
    <p class="new-collection-subheading">Timeless pieces crafted for your lifestyle.</p>
</div>
...
<div class="container-fluid py-4">
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <a href="{{ route('frontend.product_detail',['id'=>$coll->id]) }}" class="new-collection-link">
...
<style>
    ...
    .new-collection-link:hover .view-collection {
        opacity: 1;
        transform: translateX(4px);
    }

    .new-collection-link:hover .view-collection i {
