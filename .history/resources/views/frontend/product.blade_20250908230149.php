...
<style>
        ...
        * {
        ...
        .nav-item2:nth-child(1) { animation-delay: 0.1s; }
        .product-nav-item:nth-child(2) { animation-delay: 0.2s; }
        .product-nav-item:nth-child(3) { animation-delay: 0.3s; }
        .product-nav-item:nth-child(4) { animation-delay: 0.4s; }
        .product-nav-item:nth-child(5) { animation-delay: 0.5s; }
