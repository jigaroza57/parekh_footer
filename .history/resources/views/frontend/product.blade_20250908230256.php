  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js"></script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Enhanced dropdown interactions with smooth animations
            document.querySelectorAll('.dropdown').forEach(dropdown => {
                ...
                dropdown.addEventListener('show.bs.dropdown', function() {
                    toggle.style.background = 'linear-gradient(135deg, var(--primary-color), var(--primary-light))';
                    toggle.style.color = '#fff';
                    toggle.style.transform = 'translateY(-2px)';
                    toggle.style.boxShadow = '0 8px 25px rgba(88, 30, 30, 0.15)';
                });
                ...
                dropdown.addEventListener('hide.bs.dropdown', function() {
                    setTimeout(() => {
                        if (!toggle.matches(':hover')) {
                            ...
                            toggle.style.boxShadow = '0 4px 15px rgba(88, 30, 30, 0.1)';
                        }
                    }, 100);
                });
                ...
                toggle.addEventListener('mouseenter', function() {
                    if (!dropdown.classList.contains('show')) {
                        ...
                        this.style.boxShadow = '0 8px 25px rgba(88, 30, 30, 0.15)';
                    }
                });
                ...
                toggle.addEventListener('mouseleave', function() {
                    if (!dropdown.classList.contains('show')) {
                        ...
                        this.style.boxShadow = '0 4px 15px rgba(88, 30, 30, 0.1)';
                    }
                });
            });
                ...
                nav.addEventListener('scroll', () => {
                    if (!isScrolling) {
                        window.requestAnimationFrame(() => {
                            ...
                            if (nav.scrollLeft > 0) {
                                nav.style.boxShadow = 'inset 10px 0 10px -10px rgba(88, 30, 30, 0.1)';
                            } else {
                                nav.style.boxShadow = '';
                            }
                            isScrolling = false;
