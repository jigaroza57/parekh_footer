    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product-card shadow-lg rounded-4 overflow-hidden position-relative bg-white h-100">

                    <!-- Badge -->
                    @if($product->is_new)
                    <div class="product-badge position-absolute top-0 start-0 bg-danger text-white px-3 py-1 rounded-end-3">
                        New
                    </div>
                    @endif
                    ...
                    <div class="product-image overflow-hidden">
                        <a href="{{ route('frontend.product_detail', ['id' => $product->id]) }}">
                            <img src="{{ asset('images/product/' . $product->image) }}"
                                alt="{{ $product->name }}"
                                class="img-fluid w-100 product-hover">
                        </a>
                    </div>
                    ...
                    <div class="product-content p-4 text-center">
                        ...
                        <a href="{{ route('frontend.product_detail', ['id' => $product->id]) }}"
                            class="btn btn-dark rounded-pill px-4 py-2 explore-btn">
                            Explore More →
                        </a>
                    </div>
                </div>
