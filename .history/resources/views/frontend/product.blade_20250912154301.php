...
<!-- Products Section -->
<section class="products-section py-5" style="background: linear-gradient(135deg, #1f1c2c, #928dab);">
    <div class="container">
        <div class="row g-4 justify-content-center">
            @foreach($products as $product)
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product-card position-relative glass-card">
                    ...
                    <div class="product-info text-center">
                        ...
                        <p class="product-desc">
                            {{ $product->description ?? 'Premium quality crafted with care and style.' }}
                        </p>
                        <a href="{{ route('frontend.product_detail', ['id' => $product->id]) }}"
                            class="explore-btn">
