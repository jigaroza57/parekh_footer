    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-10">
                <div class="product-card creative-card fade-in shadow-lg">
                    <div class="product-image creative-img">
                        <a href="{{ route('frontend.product_detail', ['id' => $product->id]) }}">
                            <img src="{{ asset('images/product/' . $product->image) }}" alt="{{ $product->name }}">
                        </a>
                        @if($product->is_new)
                        <span class="product-badge creative-badge">New</span>
                        @endif
                    </div>
                    <div class="product-content creative-content">
                        <h4 class="product-title creative-title">{{ $product->name }}</h4>
                        <p class="product-description creative-desc">
                            {{ $product->description ?? 'Discover the amazing features and quality of this premium product.' }}
                        </p>
                        <a href="{{ route('frontend.product_detail', ['id' => $product->id]) }}" class="explore-btn creative-btn">
                            <span>Explore More</span>
                            <svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" style="margin-left:8px;" viewBox="0 0 24 24">
...
<style>
    /* Creative Product Card Styles */
    .creative-card {
        border-radius: 28px;
        background: linear-gradient(135deg, #fff 60%, #f8e7e7 100%);
        box-shadow: 0 8px 32px rgba(88, 30, 30, 0.10), 0 1.5px 6px rgba(139, 58, 58, 0.07);
        border: none;
        overflow: hidden;
        position: relative;
    ...
    .creative-card:hover {
        ...
        box-shadow: 0 18px 48px rgba(88, 30, 30, 0.18), 0 3px 12px rgba(139, 58, 58, 0.12);
    }

    .creative-img {
        background: linear-gradient(135deg, #fbeee6 60%, #f8e7e7 100%);
    ...
    .creative-img img {
        border-radius: 18px;
        box-shadow: 0 4px 18px rgba(88, 30, 30, 0.07);
        width: 100%;
        height: 180px;
        object-fit: cover;
    ...
    .creative-badge {
        ...
        top: 18px;
        left: 18px;
        background: linear-gradient(90deg, #ffb347, #ff7761);
        color: #fff;
        font-size: 13px;
        font-weight: 700;
        padding: 7px 18px;
        border-radius: 16px;
        box-shadow: 0 2px 8px rgba(255, 183, 71, 0.15);
        letter-spacing: 1px;
        z-index: 2;
    }
    ...
    .creative-btn {
        ...
        box-shadow: 0 2px 8px rgba(88, 30, 30, 0.10);
        font-size: 1rem;
        position: relative;
        overflow: hidden;
    }
    ...
    .creative-btn:hover {
        background: linear-gradient(135deg, #8B3A3A, #581E1E);
        box-shadow: 0 6px 18px rgba(88, 30, 30, 0.18);
