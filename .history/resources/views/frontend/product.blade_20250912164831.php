    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mb-4">
                <div class="product-card creative-card">
                    @if($product->is_new)
                    <div class="product-badge creative-badge">New</div>
                    @endif
                    @if($product->price)
                    <div class="creative-price-tag">₹{{ number_format($product->price, 2) }}</div>
                    @endif
                    <div class="creative-image-wrapper">
                        <a href="{{ route('frontend.product_detail', ['id' => $product->id]) }}">
                            <img src="{{ asset('images/product/' . $product->image) }}" alt="{{ $product->name }}" class="creative-product-img">
                        </a>
                        <div class="creative-overlay">
                            <a href="#" class="creative-overlay-btn" title="Add to Wishlist"><i class="fas fa-heart"></i></a>
                            <a href="{{ route('frontend.product_detail', ['id' => $product->id]) }}" class="creative-overlay-btn" title="View Details"><i class="fas fa-eye"></i></a>
                        </div>
                    </div>
                    <div class="creative-content">
                        <h4 class="creative-title">{{ $product->name }}</h4>
                        <p class="creative-description">
                            {{ $product->description ?? 'Discover the amazing features and quality of this premium product.' }}
                        </p>
                        <a href="{{ route('frontend.product_detail', ['id' => $product->id]) }}" class="creative-explore-btn">
                            Explore More
                        </a>
                    </div>
                </div>
...
<style>
    /* Add to your <style> section or a new <style> block */
    /* Glassmorphism Card */
    .creative-card {
        ...
        border: 1.5px solid rgba(139, 58, 58, 0.13);
        overflow: visible;
        position: relative;
        padding-top: 40px;
    ...
    .creative-card:hover {
        ...
        box-shadow: 0 16px 40px 0 rgba(139, 58, 58, 0.22);
    }
    ...
    .creative-price-tag {
        ...
        font-weight: 700;
        font-size: 1.1rem;
        box-shadow: 0 2px 8px rgba(139, 58, 58, 0.13);
        z-index: 3;
        letter-spacing: 1px;
    }
    ...
    .creative-product-img {
        ...
        border-radius: 50%;
        object-fit: cover;
        box-shadow: 0 8px 24px rgba(88, 30, 30, 0.18);
        border: 4px solid #fff;
        background: #fff;
        transition: transform 0.3s;
    }

    .creative-card:hover .creative-product-img {
