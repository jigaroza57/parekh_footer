    ...
    <div class="container">
        <div class="row">
            <div class="col-12 d-md-none">
                <div id="carouselExampleControls2" class="carousel slide hotel-media" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        @if($product->images)
                        @foreach(explode('|', $product->images) as $img)
                                <div class="carousel-item active">
                                    <img  src="{{ asset('public/images/product/'.$img) }}" class="d-block w-100"
                                    style="width: 100%; height: 350px; border-radius: 10px;" alt="Slide 1">
                                </div>
                        @endforeach   
                        @endif
            ...
            <div class="col-md-1" id="sub">
                <div id="thumbnails">
                @foreach(explode('|', $product->images) as $img)
                    <img src="{{ asset('public/images/product/'.$img) }}" class="thumbnail img-fluid mt-3"
            ...
            <div class="col-md-5" id="sub">
                <div id="mainImage">
                    <img  src="{{ asset('public/images/product/'.$product->image) }}" class="main-img img-fluid"
                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col-md-2 col-4">
                            <img src="{{ asset('public/images/Stars.svg')}}" style="width: 100px; height: 100px;" alt="">
                        </div>
