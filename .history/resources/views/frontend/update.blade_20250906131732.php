...
<div class="container">
            ...
            <div style="border: 1px solid black; border-radius:7px; padding: 20px;">
                <div class="row">
                    <div class="col-md-4" style="text-align: justify;">
                        <img src="{{ asset('public/images/gold.jpg')}}" class="img-fluid" style="width: 250px; height: 150px; border-radius:7px; " alt="">
                    </div>
                    <div class="col-md-8">
        ...
        <center>
            <div style="border: 1px solid black; border-radius:7px; padding: 20px; ">
                <div class="row">
                    <div class="col-md-4" style="text-align: justify;">
                        <img src="{{ asset('public/images/silver.jpg')}}" class="img-fluid" style="width: 250px; height: 150px; border-radius:7px; " alt="">
                    </div>
                    <div class="col-md-8">
                        <p id="main-text" class="mx-3 mt-3" style="text-align: justify; font-size: 22px; color: #581e1e;">
                        {!! $up->silver !!}
