          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Home Slider Image</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ route('admin.update_home_slider',['id'=>$slider->id]) }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">

                <div class="form-group">
                    <input type="text" value="{{$slider->id}}" hidden>
                    <img id="" src="{{ asset('public/images/slider/'.$slider->image)}}" alt="" style="width:100px; height:100px;" /><br>
